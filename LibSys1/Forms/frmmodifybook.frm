...
Begin VB.Form frmmodifybook 
   ...
   End
End
Attribute VB_Name = "frmmodifybook"
...
rs.Open "Select * from tbooks where booknumber=" & frmbook.Text1.Text & "", db, 3, 3
ttitle.Text = rs!Title
tauthor.Text = rs!author
tcategory.Text = rs!category
tyearpublish.Text = rs!Yearpublish
tPrice.Text = rs!Price
Set rs = Nothing
End Sub
...
End With
Set rs = Nothing
MsgBox "Book is save!", vbInformation
