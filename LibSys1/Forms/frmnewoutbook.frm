...
Begin VB.Form frmnewoutbook 
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "New Out Books"
   ClientHeight    =   2775
   ClientLeft      =   45
   ClientTop       =   285
   ClientWidth     =   4680
   ...
   End
End
Attribute VB_Name = "frmnewoutbook"
...
rs.Open "Select * from tborrowbook", db, 3, 3
